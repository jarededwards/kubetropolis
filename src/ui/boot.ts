...
export const BOOT_STEPS = {
  ...
  harbor: { pct: 63, label: 'mooring the ship…' },
  water: { pct: 70, label: 'letting in the sea…' },
  ingress: { pct: 76, label: 'opening the off-ramp…' },
  roads: { pct: 81, label: 'painting the roads…' },
